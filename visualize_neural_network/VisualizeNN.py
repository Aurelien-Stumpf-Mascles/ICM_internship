...
class Layer():
    def __init__(self, network, number_of_neurons, number_of_neurons_in_widest_layer, threshold_1, threshold_2):
    ...
    def __line_between_two_neurons(self, neuron1, neuron2, weight=0.4, textoverlaphandler=None):
        ...
        if abs_weight > self.threshold_1: 
            linewidth = 10*abs_weight
        elif abs_weight > self.threshold_2: 
...
class NeuralNetwork():
    def __init__(self, number_of_neurons_in_widest_layer, threshold_1, threshold_2):
        self.number_of_neurons_in_widest_layer = number_of_neurons_in_widest_layer
        self.layers = []
        self.layertype = 0
        self.threshold_1 = threshold_1
    ...
    def add_layer(self, number_of_neurons ):
        layer = Layer(self, number_of_neurons, self.number_of_neurons_in_widest_layer, self.threshold_1, self.threshold_2)
...
class DrawNN():
    ...
    def __init__( self, neural_network, weights_list=None, threshold_1=0.5, threshold_2=0.8 ):
        self.threshold_1 = threshold_1
        self.threshold_2 = threshold_2
    ...
    def draw( self ):
        ...
        network = NeuralNetwork( widest_layer , self.threshold_1, self.threshold_2 )
